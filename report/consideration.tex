...
The forum entries that we are trying to attribute to what we find in the corpus
}{
What the corpus is going to contain - how many entries, how large each of these is going to be, etc. \ldots
}
...
Take a post from an author appearing in the corpora with a single, long text, and see if the author can be correctly attributed compared to the entire corpus.
}{
...
As above, but only against authors who have written few posts
}{
Check the limits of the algorithm. This is likely to fail
}{
The same post as above
}{
All texts from authors who have written few posts
}

\test{
StressTest3
}{
As above, but only against authors who have written many posts
}{
Check the limits of the algorithm. This has a chance of succeeding
}{
The same post as above
}{
All texts from authors who have written many posts
}
...
Take a post from an author A with multiple long posts, and create a corpora from all the texts of A, and a short bogus post from a bogus author, and then try to see whether or not the bogus post is chosen
}{
