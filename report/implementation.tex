...
Through experimentation, I have found that it essential to not only create the 3-grams, but also the 2 and 1 grams. If these n-grams are not created, then the probability of most the n-grams will be 0, just as what happened to $p_3$ in \pref{Good-Turing}.
