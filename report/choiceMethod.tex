...
\item Might not be applicable on pictograms or symbol based alphabets (though it avoids the word barrier problem - which occurs in Chinese\footnote{See \cite{nr1} p. 540}).
